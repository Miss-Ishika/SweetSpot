    ...
    <div className="mx-2 my-4 hover:scale-105 duration-300 ">
      ...
      <div className="mx-4 py-2">
        ...
        <div className="flex justify-between my-2">
            ...
            {!cartItems[id]
              ? <img src={add} alt="add" className="w-4 h-4 cursor-pointer m-4 hover:scale-105 duration-300" onClick={() => addToCart(id)}/>
              ...
              <img src={dec} alt="dec" className="w-4 h-4 cursor-pointer m-4 hover:scale-105 duration-300" onClick={() => removeFromCart(id)}/>
                ...
                <img src={inc} alt="inc" className="w-4 h-4 cursor-pointer m-4 hover:scale-105 duration-300" onClick={() => addToCart(id)}/>  
              </div> 
            }
        </div>
      </div>
